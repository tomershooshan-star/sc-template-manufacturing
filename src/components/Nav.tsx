      ...
      <nav className="max-w-7xl mx-auto px-6 sm:px-10 lg:px-16" aria-label="Main navigation">
        <div className="flex items-center justify-between h-20">
          ...
          <Link to="/" className="flex items-center gap-3 group" aria-label="Home">
            ...
            <span
              className="text-white font-bold text-lg tracking-tight group-hover:opacity-70 transition-opacity"
              style={{ display: siteConfig.logoUrl ? 'none' : 'inline' }}
            >
          ...
          <a
            ...
            className="hidden md:inline-flex px-5 py-2.5 text-xs font-semibold tracking-wider uppercase border border-white/20 text-white hover:bg-white hover:text-black transition-all duration-300"
          >
            Contact
          </a>
